                  ...
                  Column(
                    ...
                    children: [
                      if (movie.isPostRestricted.validate() && mIsLoggedIn)
                        if (movie.restrictionSetting!.restrictType == RestrictionTypeMessage ||
                            movie.restrictionSetting!.restrictType == RestrictionTypeTemplate ||
                            movie.restrictionSetting!.restrictType.validate().isEmpty)
                          Column(
                            children: [
                              ElevatedButton(
                                onPressed: () {
                      ...
                      children: [
                        ...
                        if (snap.hasData &&
                            (snap.data!.upcomingMovie.validate().isNotEmpty ||
                                snap.data!.recommendedMovie.validate().isNotEmpty ||
                                snap.data!.upcomingVideo.validate().isNotEmpty))
                          Divider(thickness: 0.1, color: Colors.grey.shade500),
                        CommentWidget(postId: movie.id, noOfComments: movie.noOfComments).paddingAll(16).visible(movie.isCommentOpen.validate()),
                        8.height,
